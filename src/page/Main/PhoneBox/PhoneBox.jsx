...
function PhoneBox(props) {
  return (
    <section className='mt-50 mb-20 w-full h-[50vh] flex justify-center items-center'>
       <div className='w-[58%] h-[70%] flex justify-center items-center PhoneBg object-cover rounded-3xl'>
        <div className='w-[50%] h-full flex justify-center items-start  flex-col  gap-6 p-10'>
        ...
        <figure className='w-[50%] h-full flex justify-center items-end  '>

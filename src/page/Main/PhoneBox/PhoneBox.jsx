...
function PhoneBox(props) {
  return (
    <section className='mt-50 mb-20 w-full h-[50vh] flex justify-center items-center max-lg:h-auto'>
       <div className='w-[58%] h-[70%] flex justify-center items-center PhoneBg object-cover rounded-3xl max-lg:flex-col max-lg:w-[90%]'>
        <div className='w-[50%] h-full flex justify-center items-start  flex-col  gap-6 p-10 max-lg:w-full max-lg:h-auto'>
